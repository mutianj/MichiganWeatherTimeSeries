...
dat <- read.table("data/select-locations-holdout.dat", header = FALSE)
coordinates(dat) <- dat
...
write.table(dist, "data/d2lake-select-locations-holdout.dat", row.names = FALSE, col.names = FALSE)
